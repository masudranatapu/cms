                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="float-right">
                                        ...
                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#addRegionModal"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data['rows'] as $key=> $row)
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('admin.region.delete',$row->id) }}" id="deleteData" class="btn btn-danger btn-xs">Delete</a>
                                            @endif
                                        </td>
                                    </tr>
                                    @endforeach
            ...
            <div class="modal-body">
                <form action="{{ route('admin.region.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="form-control" placeholder="Region name"
                            required>
                    </div>
                    <div class="form-group">
                        <label for="code" class="form-label">Code</label>
                        <input type="text" name="code" id="code" class="form-control" placeholder="Order Number"
                            required>
                    </div>
                    <div class="form-group">
