                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="float-right">
                                        ...
                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#addCountryModal"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data['rows'] as $key=> $row)
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('admin.country.delete',$row->id) }}" id="deleteData" class="btn btn-danger btn-xs">Delete</a>
                                            @endif
                                        </td>
                                    </tr>
                                    @endforeach
