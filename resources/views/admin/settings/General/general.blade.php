...
<div class="row">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-sm-3 col-md-3">
                            <input type="file" class="form-control dropify" data-default-file="" name="logo_image"
                                data-allowed-file-extensions='["jpg", "jpeg","png","svg"]'
                                ccept="image/png, image/jpg,image/svg image/jpeg" data-max-file-size="3M">

                        </div>
                        <div class="col-sm-3 col-md-3">
                            <input type="file" class="form-control dropify" data-default-file="" name="white_logo"
                                data-allowed-file-extensions='["jpg", "jpeg","png","svg"]'
                                ccept="image/png, image/jpg,image/svg image/jpeg" data-max-file-size="3M">

                        </div>
                        <div class="col-sm-3 col-md-3">
                            <input type="file" class="form-control dropify" data-default-file="" name="favicon_image"
                                data-allowed-file-extensions='["jpg", "jpeg","png","svg"]'
                                ccept="image/png, image/jpg,image/svg image/jpeg" data-max-file-size="1M">

                        </div>
                        <div class="col-sm-3 col-md-3">
                            <input type="file" class="form-control dropify" data-default-file="" name="loader_image"
                                data-allowed-file-extensions='["jpg", "jpeg","png","svg"]'
                                ccept="image/png, image/jpg,image/svg image/jpeg" data-max-file-size="1M">
            ...
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="form-group row">
                        <input id="recaptcha_switch" type="checkbox" name="status" data-bootstrap-switch value="1"
    ...
    <!-- Watermark -->
    <div class="card">
        <form id="watermarkForm" class="form-horizontal" action="{{ route('settings.website.watermark.update') }}"
