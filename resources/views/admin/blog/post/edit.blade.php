                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body table-responsive p-4">
                            <form action="{{ route('admin.blog.post.update',$blog_post->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <img class="custom-img mt-2" src="{{ asset('assets/images/blog/'.$blog_post->image) }}" alt="Paris" width="60" height="80">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="tags[]" id="tags" value="
                                                @foreach(json_decode($blog_post->tags,true) as $key => $value)
                                                    {{ $value }}
                                                @endforeach
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="category_id" id="category_id" class="form-control" required>
                                                ...
                                                @foreach($bog_category as $category)
                                                    <option value="{{ $category->id }}" {{ $blog_post->category_id == $category->id? "selected" : "" }}>{{ $category->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select name="status" id="status" class="form-control">
                                                <option value="1" {{ $blog_post->status == 1? "selected" : "" }}>Published</option>
                                                <option value="0" {{ $blog_post->status == 0? "selected" : "" }}>Unpublished</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="details" id="summernote" class="summernote" cols="30" rows="5"
                                                class="form-control" >{{ $blog_post->details }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
